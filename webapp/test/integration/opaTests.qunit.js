...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "sodexo/corep003/test/integration/FirstJourney",
    "sodexo/corep003/test/integration/ZC_REP003_GEOSITE_REPORTListJourney",
    "sodexo/corep003/test/integration/ZC_REP003_GEOSITE_REPORTObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
